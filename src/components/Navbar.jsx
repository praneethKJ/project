    ...
    return (
        <header className="bg-black">
            <nav className="flex justify-between items-center h-16 sticky text-white z-10">
                <div className="logo text-xl mx-4"><a href="/">TubeToday</a></div>
                ...
                <div className={`md:absolute md:bg-black md:min-h-[60vh] min-h-fit left:0 md:w-full md:z-[-1] md:flex md:items-center ${isNavOpen ?'top-[9%]':'top-[-400px]'}`}>
                    <ul className="flex mx-6 md:flex-col md:m-auto md:space-y-8">
                        <li className="mr-10 md:mr-0"><a className="hover:text-red-500 active:text-gray-400 " href="">Home</a></li>
                        <li className="mr-10 md:mr-0"><a className="hover:text-red-500 active:text-gray-400" href="/">About</a></li>
                        <li className="mr-10 md:mr-0"><a className="hover:text-red-500 active:text-gray-400" href="/">Contact</a></li>
                    </ul>
                </div>
            </nav>
        </header>
