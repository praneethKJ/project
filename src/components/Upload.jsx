        ...
        <div className="container-lg flex justify-center">
            ...
            <div className="max-w-sm rounded overflow-hidden shadow-lg my-4 p-4">
                ...
                <form className="inline-block items-center" onSubmit={handleSubmit}>
                    ...
                    <input
                        className="border-2 border-black rounded-md w-[100%] xs:max-w-[90%] p-1"
                        type="text"
                        id='title'
                        value={title}
                        maxLength={50}
                    ...
                    <textarea className="border-2  border-black rounded-md w-[100%] xs:max-w-[90%]  p-1" type="text" maxLength={200} id="desc" rows="7" value={description} onChange={handleDesc} placeholder='Give a Description' />
